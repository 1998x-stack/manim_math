...
<problem>
{
  ...
  "内容": "三角比",
  "知识点": "任意角与弧度制",
  "知识点内容详细描述": "任意角：将角的概念从锐角推广到任意大小的正角、负角和零角。正角为逆时针旋转，负角为顺时针旋转。弧度制：以弧长等于半径的弧所对的圆心角为1弧度。弧度与角度的换算：π rad=180°，1 rad≈57.3°，1°=π/180 rad。弧长公式：l=|α|r；扇形面积：S=½lr=½|α|r²。弧度制使三角函数的导数公式更加简洁。",
  "数学公式": [
    "π rad = 180°",
    "1 rad = 180°/π ≈ 57.3°",
    "1° = π/180 rad",
