...
class Topic004一元一次不等式的解法Animation(Scene):
    """
    004一元一次不等式的解法 教学动画场景
    """
    ...
    def show_summary(self):
        ...
        summary_points = VGroup(
            Text("✓ 今天我们学习了004一元一次不等式的解法", font="Noto Sans CJK SC", font_size=28, color=self.COLOR_PRIMARY),
