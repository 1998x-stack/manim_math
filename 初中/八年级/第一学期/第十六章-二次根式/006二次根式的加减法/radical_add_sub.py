...
class RadicalAddSub(Scene):
    ...
    def scene_opening(self):
        ...
        wrong_l  = Text("直觉（错！）：", font="PingFang SC", font_size=24, color=self.C_WRONG)
        ...
        right_l  = Text("正确答案：", font="PingFang SC", font_size=24, color=self.C_RESULT)
    ...
    def scene_ex1_direct(self):
        ...
        same_t1 = Text("被开方数均为 3 →", font="PingFang SC", font_size=24, color=self.C_STEP2)
        same_t2 = Text("同类！", font="PingFang SC", font_size=24, color=self.C_RESULT)
    ...
    def scene_ex2_main(self):
        ...
        s1_tag = Text("Step 1  化简各项", font="PingFang SC", font_size=24, color=self.C_STEP1)
        ...
        s2_tag = Text("Step 2  代入", font="PingFang SC", font_size=24, color=self.C_STEP2)
        ...
        s3_tag = Text("Step 3  合并", font="PingFang SC", font_size=24, color=self.C_STEP3)
    ...
    def scene_ex3_subtract(self):
        ...
        simp_t  = Text("化简 √12：", font="PingFang SC", font_size=26, color=self.C_STEP1)
        ...
        coeff_t       = Text(
            "注意：√3 前系数是 1，不要忘记！",
            font="PingFang SC", font_size=24, color=self.C_COEFF,
        ).move_to(DOWN * 0.4)
    ...
    def scene_ex4_mixed(self):
        ...
        prob_l  = Text("计算：", font="PingFang SC", font_size=26, color=GRAY_A)
        ...
        simp_t  = Text("各项化简：", font="PingFang SC", font_size=24, color=self.C_STEP1)
        ...
        merge_t  = Text("代入合并：", font="PingFang SC", font_size=24, color=self.C_STEP3)
    ...
    def scene_cannot_merge(self):
        ...
        case_t1 = Text("化简后被开方数不同：", font="PingFang SC", font_size=26, color=self.C_WRONG)
        case_f  = MathTex(r"\sqrt{2}+\sqrt{3}", font_size=50, color=WHITE)
        case_t2 = Text("→ 已是最简，无法合并", font="PingFang SC", font_size=22, color=GRAY_A)
        ...
        ver_t     = Text("数值验证：", font="PingFang SC", font_size=24, color=self.C_STEP1)
        ...
        correct_t1 = Text("正确处理：保留原式", font="PingFang SC", font_size=26, color=self.C_STEP3)
    ...
    def scene_quick_practice(self):
        ...
        for i, (prob, result, col, hint) in enumerate(items):
            ...
            ht    = Text(hint, font="PingFang SC", font_size=19, color=GRAY_A)
