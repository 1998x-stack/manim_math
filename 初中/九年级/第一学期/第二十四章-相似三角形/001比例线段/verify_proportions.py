"""本课独立的纯数学及源码检查；无需安装 Manim。

运行：python 初中/九年级/第一学期/第二十四章-相似三角形/001比例线段/verify_proportions.py
"""
...
SOURCE = Path(__file__).with_name("proportional_segments.py")
...
def run_checks():
    ...
    print("PASS: syntax, 20 math/boundary assertions, Scene entry, TeX text, play nesting")
